...
**- CẢNH BÁO 2: Nếu dùng EFI này để cài macOS High Sierra, bạn cần có bộ cài macOS High Sierra 10.13.6 có tích hợp bản cập nhật bổ sung dành cho kiểu máy MacBook Pro 2018 (mã build 17G2112). Vì EFI này sử dụng SMBIOS của MacBook Pro 2018, nhờ bản cập nhật này mà macOS High Sierra được cập nhật kext đồ họa mới và ta có thể điều chỉnh độ sáng. Đa phần các bộ cài macOS High Siera trôi nổi trên mạng đều là bản cũ hoặc thấp hơn version này nên khi bạn boot vào sẽ xảy ra một trong hai lỗi như sau (kể cả bộ cài Online tải từ trang hướng dẫn của Dortania hoặc bộ cài macOS High Sierra 10.13.6 gốc vẫn sẽ bị):**
